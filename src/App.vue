...
<template>
  <div class="grid place-items-center h-screen grid-cols-3">
    <div class="col-span-3">
      <div class="grid grid-cols-3">
        <figure
          class="col-start-2 relative gap-6 flex items-center flex-col-reverse neutralColor2 rounded-lg px-6 pt-8 pb-20 dark:bg-slate-800 dark:highlight-white/5">
